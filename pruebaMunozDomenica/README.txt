...
a persistence unit "pruebaMunozDomenicaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaMunozDomenica\pom.xml":
...
artifact ("pruebaMunozDomenica.war") is already built. You can build
